...
using CNET_V7_Entities.DataModels;
using CNET_V7_Service.Contracts;
using CNET_V7_Service.Contracts.SCHEMASchema;
...
namespace CNET_V7_Presentation.BaseControllers.SCHEMASchema
{
    ...
    public class MODEL_NAMEController : ControllerBase
    {
        ...
        public MODEL_NAMEController(IServiceManager serviceManager)
        {
        ...
        {
            var obj = await _serviceManager.MODEL_NAME_CAMILEService.FindById(id);
        ...
        {
            var accounts = await _serviceManager.MODEL_NAME_CAMILEService.FindAll(trackChanges: false);
            if(accounts.Success)
        ...
        public async Task<IActionResult> CreateMODEL_NAME([FromBody] MODEL_NAMEDTO PARAMETER)
        {
            ...
            var createdObj = await _serviceManager.MODEL_NAME_CAMILEService.Create(PARAMETER);
        ...
        public async Task<IActionResult> UpdateMODEL_NAME([FromBody] MODEL_NAMEDTO PARAMETER)
        {
            ...
            var updatedObject = await _serviceManager.MODEL_NAME_CAMILEService.Update(PARAMETER);
        ...
        {
            var deletedObject = await _serviceManager.MODEL_NAME_CAMILEService.Delete(id);
